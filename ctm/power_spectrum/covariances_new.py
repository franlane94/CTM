...
class ZeldovichJ1(mcfit.mcfit):
    ...
    def __init__(self, k):
        ...
        # set pre and post factors
        self.prefac = 1.0
        self.postfac = 1.0/(2.0*np.pi)**1.5/self.y
...
def dosph(n, x, f, a, tilt=1.5):
    ...
    return sph(x, nu=n, q=tilt, lowring=False)(func, extrap=True)
...
def calc_sigma_psi(k, P):
    ...
    q, I0 = ZeldovichJ0(k)(P(k), extrap=True)
    sigma_vals = I0/3.0
...
def calc_X_and_Y(k, P, sigma):
    ...
    q, I0 = ZeldovichJ0(k)(P(k), extrap=True)
    _, I1 = ZeldovichJ1(k)(P(k), extrap=True)
